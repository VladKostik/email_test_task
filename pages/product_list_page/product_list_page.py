...
class ProductListPage(BasePage):
    ...
    def find_add_to_favourite_element_to_compare(self) -> WebElement:
        return self._wait_for_element_located_and_visible(self.__locators_collection.add_to_favourite_element_btn_css)
    ...
    def click_add_to_favourite_btn(self) -> None:
        self._click(self.__locators_collection.add_to_favourite_element_btn_css)
